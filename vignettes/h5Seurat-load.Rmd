...
This vignette serves as a guide to saving and loading `Seurat` objects to h5Seurat files. H5Seurat files are a novel, [HDF5](https://en.wikipedia.org/wiki/Hierarchical_Data_Format)-based file format designed for storing multi-modal single-cell expression data and associated metadata, including nearest-neighbor graphs, dimensional reduction information, spatial coordinates and image data, clustering labels, and any other metadata. For more details about h5Seurat files, please see the [h5Seurat file specification](https://mojaveazure.github.io/seurat-disk/articles/h5Seurat-spec.html).
...
```{r hfile}
hfile <- h5Seurat$new(filename = "anterior1.h5Seurat", mode = "r")
hfile
```
...
```{r bad_reduc}
brain2 <- LoadH5Seurat("anterior1.h5Seurat", assays = "SCT", reductions = "pca")
brain2
```
...
```{r append_partial}
brain2 <- AppendData("anterior1.h5Seurat", brain2, assays = FALSE, reductions = NA, graphs = FALSE, images = FALSE)
brain2
```
