...
<a href=`r plink("DimReduc-class")`>Dimensional reduction information</a> is stored in the top-level group "reductions"; each dimensional reduction is stored as its own group within the "reductions" group.
